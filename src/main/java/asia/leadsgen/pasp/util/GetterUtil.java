...
public class GetterUtil {
	...
	public static final String DEFAULT_STRING = StringPool.BLANK.getValue();
	...
	public static String get(String value, String defaultValue) {
		...
		if (value.indexOf(CharPool.RETURN) != -1) {
			value = value.replaceAll(StringPool.RETURN_NEW_LINE.getValue(), StringPool.NEW_LINE.getValue());
		}
